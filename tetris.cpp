...
Tetris::Tetris(){
  ...
  tiles.loadFromFile("C:/Users/Дарья/Desktop/tetris/tetris-main/resources/img/squares.png");   
  sprite = std::make_shared<sf::Sprite>();
  sprite->setTexture( tiles );
  sprite->setTextureRect(sf::IntRect(0, 0, 36, 36));

  bg.loadFromFile("C:/Users/Дарья/Desktop/tetris/tetris-main/resources/img/background.png");
  ...
  font.loadFromFile("C:/Users/Дарья/Desktop/tetris/tetris-main/resources/font/font.ttf");  
  txtScore.setFont(font);
  txtScore.setPosition(65.f, 10.f);
